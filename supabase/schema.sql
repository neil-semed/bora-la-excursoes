...
create table if not exists excursions (
  ...
  -- fluxo de aprovação em 2 etapas: pedagogia -> admin (define veículo/motorista)
...
create policy "excursions_select" on excursions for select
  using (
    ...
    or (public.current_role_name() = 'motorista' and assigned_driver_id = public.current_driver_id())
  );
...
insert into drivers (name, cnh, phone, cooperative) values
  ('João Silva', '01234567890', '(31) 99999-1111', 'CoopTrans'),
  ('Pedro Santos', '09876543210', '(31) 99999-2222', 'CoopTrans')
on conflict do nothing;
